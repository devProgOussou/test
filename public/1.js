                      ...
                      [
                        ...
                        user.isActive == true
                          ? _c(
                              "inertia-link",
                              {
                                attrs: {
                                  href:
                                    "http://alpha-tests.defarsci.com/samba-store-v2/public/userDeactivate/" +
                                    user.id
                                }
                              },
                              [
                        ...
                        user.isActive == false
                          ? _c(
                              "inertia-link",
                              {
                                attrs: {
                                  href:
                                    "http://alpha-tests.defarsci.com/samba-store-v2/public/userActivate/" +
                                    user.id
                                }
                              },
                              [
                        ...
                        _c(
                          "inertia-link",
                          {
                            attrs: {
                              href:
                                "http://alpha-tests.defarsci.com/samba-store-v2/public/userDelete/" +
                                user.id
                            }
                          },
                          [
